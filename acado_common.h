 ...
 * 
 *  Matrix containing 5 differential variable vectors.
 */
real_t x[ 25 ];

/** Column vector of size: 4
 * 
 *  Matrix containing 4 control variable vectors.
 */
real_t u[ 4 ];

/** Column vector of size: 16
 * 
 *  Matrix containing 4 reference/measurement vectors of size 4 for first 4 nodes.
 */
real_t y[ 16 ];

/** Column vector of size: 1
 * 
 *  Reference/measurement vector for the 5. node.
 */
real_t yN[ 1 ];
...
/** Matrix of size: 3 x 35 (row major format) */
real_t rk_kkk[ 105 ];
 ...
 *
 *  \param strategy Shifting strategy: 1. Initialize node 5 with xEnd. 2. Initialize node 5 by forward simulation.
