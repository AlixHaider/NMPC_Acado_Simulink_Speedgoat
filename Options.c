									...
									)
{
	...
	_THIS->terminationTolerance          =  1.0e2 * QPOASES_EPS1;
	_THIS->boundTolerance                =  1.0e2 * QPOASES_EPS1;
	#else
	_THIS->terminationTolerance          =  5.0e6 * QPOASES_EPS1;
	_THIS->boundTolerance                =  1.0e6 * QPOASES_EPS1;
	#endif
	_THIS->boundRelaxation               =  1.0e4;
	#ifdef __USE_SINGLE_PRECISION__
	_THIS->epsNum                        = -1.0e2 * QPOASES_EPS1;
	_THIS->epsDen                        =  1.0e2 * QPOASES_EPS1;
	#else
	_THIS->epsNum                        = -1.0e3 * QPOASES_EPS1;
	_THIS->epsDen                        =  1.0e3 * QPOASES_EPS1;
	#endif
	...
	#ifdef __USE_SINGLE_PRECISION__
	_THIS->epsFlipping                   =  5.0e1 * QPOASES_EPS1;
	#else
	_THIS->epsFlipping                   =  1.0e3 * QPOASES_EPS1;
	#endif
	_THIS->numRegularisationSteps        =  0;
	#ifdef __USE_SINGLE_PRECISION__
	_THIS->epsRegularisation             =  2.0e1 * QPOASES_EPS1;
	_THIS->numRefinementSteps            =  2;
	#else
	_THIS->epsRegularisation             =  1.0e3 * QPOASES_EPS1;
	_THIS->numRefinementSteps            =  1;
	#endif
	_THIS->epsIterRef                    =  1.0e2 * QPOASES_EPS1;
	#ifdef __USE_SINGLE_PRECISION__
	_THIS->epsLITests                    =  5.0e1 * QPOASES_EPS1;
	_THIS->epsNZCTests                   =  1.0e2 * QPOASES_EPS1;
	#else
	_THIS->epsLITests                    =  1.0e5 * QPOASES_EPS1;
	_THIS->epsNZCTests                   =  3.0e3 * QPOASES_EPS1;
	#endif
								...
								)
{
	...
	#ifdef __USE_SINGLE_PRECISION__
	_THIS->terminationTolerance          =  1.0e3 * QPOASES_EPS1;
	#else
	_THIS->terminationTolerance          =  1.0e9 * QPOASES_EPS1;
	#endif
										...
										)
{
    ...
    */
	...
	{
		_THIS->terminationTolerance = QPOASES_EPS1;
		needToAdjust = BT_TRUE;
	}

	if ( _THIS->epsIterRef <= 0.0 )
	{
		_THIS->epsIterRef = QPOASES_EPS1;
		needToAdjust = BT_TRUE;
	}

	if ( _THIS->epsRegularisation <= 0.0 )
	{
		_THIS->epsRegularisation = QPOASES_EPS1;
		needToAdjust = BT_TRUE;
	}

	if ( _THIS->boundTolerance <= 0.0 )
	{
		_THIS->boundTolerance = QPOASES_EPS1;
		needToAdjust = BT_TRUE;
	}

	if ( _THIS->boundRelaxation <= 0.0 )
	{
		_THIS->boundRelaxation = QPOASES_EPS1;
		needToAdjust = BT_TRUE;
	}
	
	if ( _THIS->maxPrimalJump <= 0.0 )
	{
		_THIS->maxPrimalJump = QPOASES_EPS1;
		needToAdjust = BT_TRUE;
	}

	if ( _THIS->maxDualJump <= 0.0 )
	{
		_THIS->maxDualJump = QPOASES_EPS1;
		needToAdjust = BT_TRUE;
	}
	...
	{
		_THIS->initialFarBounds = _THIS->boundRelaxation+QPOASES_EPS1;
		needToAdjust = BT_TRUE;
	}
	...
	{
		_THIS->epsFlipping = QPOASES_EPS1;
		needToAdjust = BT_TRUE;
	}
	...
	{
		_THIS->epsLITests = QPOASES_EPS1;
		needToAdjust = BT_TRUE;
	}

	if ( _THIS->epsNZCTests < 0.0 )
	{
		_THIS->epsNZCTests = QPOASES_EPS1;
		needToAdjust = BT_TRUE;
	}
